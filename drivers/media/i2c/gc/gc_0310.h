...
#define GC_FOCAL_LENGTH_DEFAULT 0x1710064 // TODO: product specific 
/*
 * current f-number bits definition:
 * bits 31-16: numerator, bits 15-0: denominator
 */
#define GC_F_NUMBER_DEFAULT 0x16000a // TODO: product specific 
 ...
 */
#define GC_F_NUMBER_RANGE 0x160a160a // TODO: product specific 
...
static struct gc_table_map gc0310_exposure_tables[] = {
	{-2, gc0310_exposure_neg4},
	{-1, gc0310_exposure_neg3},
	{-0, gc0310_exposure_neg2},
	{1, gc0310_exposure_neg1},
	{2, gc0310_exposure_zero},
	{3, gc0310_exposure_pos1},
	{4, gc0310_exposure_pos2},
	{5, gc0310_exposure_pos3},
	{6, gc0310_exposure_pos4},
};



/* Init/common settings across all modes */
...
/////////////////////////////////////////////////
{GC_8BIT, 	0x40,0xff },
{GC_8BIT, 	0x41,0x21}, //21
{GC_8BIT, 	0x42,0xcf}, // cf
{GC_8BIT, 	0x44,0x01},
{GC_8BIT, 	0x45,0xaf },
{GC_8BIT, 	0x46,0x02}, // sync
{GC_8BIT, 	0x4a,0x11},
{GC_8BIT, 	0x4b,0x01},
{GC_8BIT, 	0x4c,0x20},
{GC_8BIT, 	0x4d,0x05},
...
///////////////////   DNDD	/////////////////////
///////////////////////////////////////////////// 
{GC_8BIT, 	0x82,0x1f}, // 06
{GC_8BIT, 	0x83,0x0b}, //0B
{GC_8BIT, 	0x89,0xf0},
...
//////////////////banding  MCLK=19.2MHz//////////////////////
{GC_8BIT, 	0xfe, 0x00 },
{GC_8BIT, 	0x05, 0x01	},
{GC_8BIT, 	0x06, 0x32}, //hb
{GC_8BIT, 	0x07, 0x00},
{GC_8BIT, 	0x08, 0x58}, //vb

{GC_8BIT, 	0xfe, 0x01},
{GC_8BIT, 	0x25, 0x00},   //anti-flicker step [11:8]
{GC_8BIT, 	0x26, 0x60},   //anti-flicker step [7:0]

{GC_8BIT, 	0x27, 0x02},   //exp level 0  16.67fps
{GC_8BIT, 	0x28, 0x40 },
{GC_8BIT, 	0x29, 0x03},   //exp level 1  12,5fps
{GC_8BIT, 	0x2a, 0x00		},
{GC_8BIT, 	0x2b, 0x03},   //exp level 2  8.33fps //0516 10fps
{GC_8BIT, 	0x2c, 0xc0},
{GC_8BIT, 	0x2d, 0x05},   //exp level 3  6.67fps
{GC_8BIT, 	0x2e, 0xa0},
{GC_8BIT, 	0x3c, 0x20	},
{GC_8BIT, 	0xfe, 0x00		},
...
//////////////////////////////stream on////////////////////////////////////
//mipi reset
// SHAMIM: donot touch the system registers here	      
//{GC_8BIT, 	0xfe, 0x30},
//{GC_8BIT, 	0xfe, 0x30},
// SHAMIM
{GC_8BIT, 	0xfe, 0x03},
...
//////////////////////////////stream on////////////////////////////////////
//mipi reset	     
// SHAMIM: donot touch system registers here 
//{GC_8BIT, 	0xfe, 0x30},
//{GC_8BIT, 	0xfe, 0x30},
// SHAMIM
{GC_8BIT, 	0xfe, 0x03},
...
/*
{GC_8BIT, 0xfe, 0x03},
{GC_8BIT, 0x01, 0x03}, ///mipi 1lane
{GC_8BIT, 0x02, 0x22},
{GC_8BIT, 0x03, 0x94},
{GC_8BIT, 0x04, 0x01}, // fifo_prog
{GC_8BIT, 0x05, 0x00}, //fifo_prog
{GC_8BIT, 0x06, 0x80}, //b0  //YUV ISP data
{GC_8BIT, 0x11, 0x2a}, //LDI set YUV422
{GC_8BIT, 0x12, 0x90}, //04 //00 //04//00 //LWC[7:0]	//
{GC_8BIT, 0x13, 0x02}, //05 //LWC[15:8]
{GC_8BIT, 0x15, 0x12}, //DPHYY_MODE read_ready
{GC_8BIT, 0x17, 0x01}, //f0
{GC_8BIT, 0x42, 0x90},
{GC_8BIT, 0x43, 0x02},
*/
...
{GC_8BIT, 0x22, 0x02},
{GC_8BIT, 0x23, 0x01},
{GC_8BIT, 0x29, 0x02},//02
{GC_8BIT, 0x2a, 0x02},//04
{GC_8BIT, 0xfe, 0x00},
{GC_8BIT, 0x4d, 0x01},
{GC_8BIT, 0x86, 0x50},
{GC_8BIT, 0x87, 0x30},
...
/* TODO: Settings for each mode still need to be updated*/
struct gc_resolution gc0310_res_still[] = {
    {
		.desc = "gc0310_640x480",
		.regs = gc0310_640x480,
		.width = 640,
...
struct gc_resolution gc0310_res_preview[] = {
   {
		.desc = "gc0310_640x480",
		.regs = gc0310_640x480,
		.width = 640,
...
struct gc_mode_info gc0310_mode_info[] = {
	[0] = {
		.init_settings = NULL, /* gc0310_init_settings,*/
...
#define GC0310_RES_WIDTH_MAX	1616
#define GC0310_RES_HEIGHT_MAX	1216
...
static struct gc_register gc0310_stream_on[] = {
    // SHAMIM: try this - remove if streaming problem isnt solved
    {GC_8BIT, 0xfe, 0x30},
    // 
	{GC_8BIT, 0xfe, 0x03},
	{GC_8BIT, 0x10, 0x94},
...
static struct gc_register gc0310_stream_off[] = {
	{GC_8BIT, 0xfe, 0x03},
	{GC_8BIT, 0x10, 0x84}, // try 0x80 as well if doesnt work
	{GC_8BIT, 0xfe, 0x00},
	{GC_TOK_TERM, 0, 0},
};
...
/* no need with new class driver design - TODO delete
inline int gc_get_product_info(struct gc_product_info *info)
{
	*info = product_gc0310_info;
	return 0;
}
*/
