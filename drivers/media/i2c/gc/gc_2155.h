...
static struct gc_table_map gc2155_exposure_tables[] = {
	{-2, gc2155_exposure_neg4},
	{-1, gc2155_exposure_neg3},
	{-0, gc2155_exposure_neg2},
	{1, gc2155_exposure_neg1},
	{2, gc2155_exposure_zero},
	{3, gc2155_exposure_pos1},
	{4, gc2155_exposure_pos2},
	{5, gc2155_exposure_pos3},
	{6, gc2155_exposure_pos4},
};



/* Init/common settings across all modes */
static struct gc_register const gc2155_init_settings[] = {
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfc, 0x06 },
	...
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0xf2, 0x00 },
	/* For now at init dont program mipi at all */
	{ GC_TOK_TERM, 0, 0}
};
...
static struct gc_register const gc2155_1280x720[] = {
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfc, 0x06 },
...
static struct gc_register const gc2155_still_1600x1200[] = {
/*
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
...
*/
	/* ISP reg */
	{ GC_8BIT, 0xfe, 0x00 },
	{ GC_8BIT, 0x03, 0x04 }, /* exp time */
	{ GC_8BIT, 0x04, 0xe2 }, /* exp time */
	{ GC_8BIT, 0x09, 0x00 }, /* row start */
	{ GC_8BIT, 0x0a, 0x00 },
	{ GC_8BIT, 0x0b, 0x00 }, /* col start */
	{ GC_8BIT, 0x0c, 0x00 },
	{ GC_8BIT, 0x0d, 0x04 }, /* height:0x04c0 */
	{ GC_8BIT, 0x0e, 0xc0 },
	{ GC_8BIT, 0x0f, 0x06 }, /* width */
	{ GC_8BIT, 0x10, 0x50 },
...
/* Video and preview */
static struct gc_register const gc2155_800x600[] = {
/*
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
	{ GC_8BIT, 0xfe, 0xf0 },
...
static struct gc_register const gc2155_1280x960[] = {
...
struct gc_resolution gc2155_res_still[] = {
    {
...
struct gc_resolution gc2155_res_preview[] = {
   {
		.desc = "gc2155_1280x960",
		.regs = gc2155_1280x960,
		.width = 1280,
