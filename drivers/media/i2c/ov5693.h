...
/*
 * 480p=720*480 30fps 8.8ms VBlanking 2lane 10Bit (Scaling)
 */
...
/*
 * 720p=1280*720 30fps 8.8ms VBlanking 2lane 10Bit (no-Scaling)
 */
...
static struct ov5693_reg const ov5693_1296x976[] = {
	...
	{OV5693_8BIT, 0x3820, 0x04},//0x04  vfast bin on,vflip off,vbin off
	{OV5693_8BIT, 0x3821, 0x1f},//0x1f   hsync on,h mirror on,hbin on
	{OV5693_8BIT, 0x5002, 0x00},
	{OV5693_TOK_TERM, 0, 0}
};
