...
typedef struct ia_css_psys_event_descriptor ia_css_psys_event_descriptor_t;
...
struct ia_css_psys_event_descriptor {
	ia_css_psys_event_type_t type;
	/* cookie might contain frame or process group or other items relevant to
	 * the event being define. TBD */
	void *cookie;
};

extern int ia_css_psys_handle_event(ia_css_psys_event_descriptor_t *event);
